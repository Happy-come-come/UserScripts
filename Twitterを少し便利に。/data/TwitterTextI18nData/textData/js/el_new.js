const text = {
	...
	"tweetsRetweeted": {"type":"apkI18nTemplateFunction","value":"%s αναδημοσίευσε"},
	"retweet": {"type":"string","value":"Αναδημοσίευση"},
	"unDoRetweet": {"type":"string","value":"Αναίρεση αναδημοσίευσης"},
	"quoteTweet": {"type":"string","value":"Παράθεση"},
	"profileTabTitleTimeline": {"type":"string","value":"Αναρτήσεις"},
	...
	"postTweet": {"type":"string","value":"Δημοσίευση"},
