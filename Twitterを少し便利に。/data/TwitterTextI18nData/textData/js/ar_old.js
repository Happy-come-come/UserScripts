const text = {
	...
	"grokCreateVersion": {"type":"string","value":"أنشئ نسختك باستخدام Grok"},
	"grokAskYourself": {"type":"string","value":"اسأل Grok بنفسك"},
	"grokWebPages": {
		"type": "webI18nFunction",
		"arguments": ["count"],
	...
	"viewLatestPost": {"type":"string","value":"شاهد أحدث المنشورات"},
	...
	"follow": {"type":"string","value":"متابعة"},
	...
	"creatorStudio": {"type":"string","value":"إستوديو منشئ المحتوى"},
