const text = {
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return[props.formattedCount+" פוסט"+t(props.count,"ים","","ים","ים")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return[props.formattedCount+" אוהב"+t(props.count,"","ים","","")]}
	},
	"mediaNum": {
		"type": "webI18nTemplateFunction",
	...
	"business": {"type":"string","value":"עסק"},
	...
	"creatorStudio": {"type":"string","value":"הסטודיו ליוצרים"},
