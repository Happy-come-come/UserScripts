const text = {
	...
	"profileTabTitleTimeline": {"type":"string","value":"ટ્વીટસ્"},
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" પોસ્ટ"+t(props.count,"","્સ ")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" લાઈક"+t(props.count,"","્સ")]}
	},
	"mediaNum": {
		"type": "webI18nTemplateFunction",
	...
	"creatorStudio": {"type":"string","value":"નિર્માતા સ્ટૂડિયો"},
	...
	"moreMenu": {"type":"string","value":"વધુ"},
	...
	"postTweet": {"type":"string","value":"ટ્વીટ"},
