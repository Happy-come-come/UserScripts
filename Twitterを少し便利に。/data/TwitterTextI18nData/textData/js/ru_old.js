const text = {
	...
	"tweetsRetweeted": {"type":"apkI18nTemplateFunction","value":"%s ретвитнул(а)"},
	...
	"grokShowMore": {"type":"string","value":"Показать еще"},
	...
	"profileTabTitleTimeline": {"type":"string","value":"Твиты"},
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" твит"+n(props.count,"а","ов","","а")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
	...
	"creatorStudio": {"type":"string","value":"Творческая студия"},
	...
	"postTweet": {"type":"string","value":"Твитнуть"},
