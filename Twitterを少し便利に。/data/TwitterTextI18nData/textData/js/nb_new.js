const text = {
	...
	"tweetsRetweeted": {"type":"apkI18nTemplateFunction","value":"%s republiserte"},
	"retweet": {"type":"string","value":"Republiser"},
	"unDoRetweet": {"type":"string","value":"Angre republisering"},
	"quoteTweet": {"type":"string","value":"Sitat"},
	"profileTabTitleTimeline": {"type":"string","value":"Innlegg"},
	...
	"connect_people": {"type":"string","value":"Koble til"},
	...
	"postTweet": {"type":"string","value":"Publiser"},
