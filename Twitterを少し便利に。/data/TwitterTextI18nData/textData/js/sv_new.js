const text = {
	...
	"tweetsRetweeted": {"type":"apkI18nTemplateFunction","value":"%s återpublicerade"},
	...
	"pollVotes": {
		...
		"value": function(e){return e.formattedCount+" röst"+i(e.count,"","er")}
	},
	"pollEnded": {"type":"string","value":"Slutresultat"},
	"retweet": {"type":"string","value":"Återpublicera"},
	"unDoRetweet": {"type":"string","value":"Ångra återpublicering"},
	"quoteTweet": {"type":"string","value":"Citat"},
	"profileTabTitleTimeline": {"type":"string","value":"Inlägg"},
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" inlägg"]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" gilla-markering"+i(props.count,"","ar")]}
	},
	"mediaNum": {
		"type": "webI18nTemplateFunction",
	...
	"postTweet": {"type":"string","value":"Lägg upp"},
