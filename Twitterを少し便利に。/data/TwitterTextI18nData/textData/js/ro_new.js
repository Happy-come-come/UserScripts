const text = {
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return[props.formattedCount+" post"+r(props.count,"ări","are","ări")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
	...
	"postTweet": {"type":"string","value":"Postare"},
