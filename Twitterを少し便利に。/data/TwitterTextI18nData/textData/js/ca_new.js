const text = {
	...
	"opensEditHistory": {"type":"string","value":"Obre l'historial de canvis"},
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" publicaci"+s(props.count,"ó","ons")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" Agradament"+s(props.count,"","s")]}
	},
	"mediaNum": {
		"type": "webI18nTemplateFunction",
