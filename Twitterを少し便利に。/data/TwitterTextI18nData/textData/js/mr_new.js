const text = {
	...
	"pollVotes": {
		...
		"value": function(e){return e.formattedCount+" मत"+t(e.count,"","े")}
	},
	...
	"profileTabTitleTimeline": {"type":"string","value":"ट्विट्स"},
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" पोस्ट"+t(props.count,"","्स")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
	...
	"postTweet": {"type":"string","value":"ट्विट"},
