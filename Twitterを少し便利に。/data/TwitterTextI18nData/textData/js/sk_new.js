const text = {
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" "+i(props.count,"príspevky","príspevku","nový príspevok","príspevku")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" označen"+i(props.count,"ia","ia","ie","í")+" Páči sa"]}
	},
	"mediaNum": {
		"type": "webI18nTemplateFunction",
