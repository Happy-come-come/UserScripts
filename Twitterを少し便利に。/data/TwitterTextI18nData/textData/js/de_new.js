const text = {
	...
	"tweetsRetweeted": {"type":"apkI18nTemplateFunction","value":"%s hat repostet"},
	...
	"pollVotes": {
		...
		"value": function(e){return e.formattedCount+" Stimme"+a(e.count,"","n")}
	},
	"pollEnded": {"type":"string","value":"Endergebnisse"},
	"retweet": {"type":"string","value":"Reposten"},
	"unDoRetweet": {"type":"string","value":"Repost rückgängig machen"},
	"quoteTweet": {"type":"string","value":"Zitat"},
	...
	"joinDateFrom": {
		"type": "webI18nFunction",
		"arguments": ["joinDate"],
		"value": function(e){return" Beigetreten "+e.joinDate}
	},
	"followedBy1": {
		"type": "webI18nTemplateFunction",
	...
	"likesNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" „Gefällt mir“-Angabe"+a(props.count,"","n")]}
	},
	"mediaNum": {
		"type": "webI18nTemplateFunction",
	...
	"postTweet": {"type":"string","value":"Posten"},
