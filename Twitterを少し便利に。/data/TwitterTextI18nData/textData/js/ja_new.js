const text = {
	...
	"tweetsRetweeted": {"type":"apkI18nTemplateFunction","value":"%sさんがリポストしました"},
	...
	"retweet": {"type":"string","value":"リポスト"},
	"unDoRetweet": {"type":"string","value":"ポストを取り消す"},
	"quoteTweet": {"type":"string","value":"引用"},
	"profileTabTitleTimeline": {"type":"string","value":"ポスト"},
	...
	"joinDateFrom": {
		"type": "webI18nFunction",
		"arguments": ["joinDate"],
		"value": function(e){return e.joinDate+"からXを利用しています"}
	},
	"followedBy1": {
		"type": "webI18nTemplateFunction",
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" 件のポスト"]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
	...
	"creatorStudio": {"type":"string","value":"クリエイタースタジオ"},
	...
	"postTweet": {"type":"string","value":"ポストする"},
