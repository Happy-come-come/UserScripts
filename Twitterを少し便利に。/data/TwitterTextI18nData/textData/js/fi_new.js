const text = {
	"forYouTab": {
		...
		"arguments": ["noun"],
		"value": function(a){return"Sinulle"+a.noun}
	},
	"followingTab": {
		"type": "webI18nFunction",
		"arguments": ["noun"],
		"value": function(a){return"Seurataan"+a.noun}
	},
	"pinnedListsModuleHeader": {"type":"string","value":"Kiinnitetyt"},
	"tweetsRetweeted": {"type":"apkI18nTemplateFunction","value":"%s uudelleenjulkaisi"},
	...
	"pollVotes": {
		...
		"value": function(a){return a.formattedCount+" ään"+s(a.count,"i","tä")}
	},
	"pollEnded": {"type":"string","value":"Lopulliset tulokset"},
	"retweet": {"type":"string","value":"Uudelleenjulkaise"},
	"unDoRetweet": {"type":"string","value":"Peru uudelleenjulkaisu"},
	"quoteTweet": {"type":"string","value":"Lainaa"},
	"profileTabTitleTimeline": {"type":"string","value":"Julkaisut"},
	...
	"joinDateFrom": {
		"type": "webI18nFunction",
		"arguments": ["joinDate"],
		"value": function(a){return"Liittyi "+a.joinDate}
	},
	"followedBy1": {
		"type": "webI18nTemplateFunction",
	...
	"postedTweetsNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" julkaisu"+s(props.count,"","a")]}
	},
	"likesNum": {
		"type": "webI18nTemplateFunction",
		"value": function(){return [props.formattedCount+" tykkäys"+s(props.count,"","tä")]}
	},
	"mediaNum": {
		"type": "webI18nTemplateFunction",
	...
	"switchToAccount": {
		...
		"value": function(a){return"Vaihda tiliin @"+a.screenName}
	},
	"postTweet": {"type":"string","value":"Julkaise"},
