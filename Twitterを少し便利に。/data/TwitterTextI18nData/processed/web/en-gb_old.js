const text = {
	...
	"bb1e43e4": "Anyone (even listeners) can make clips. The only catch is that you have to be signed in to Twitter.",
	...
	"d82f2140": "Tune in to live audio conversations",
	...
	"bfb01c62": "No, go back",
	"ibd16282": "Provide a link to the official website of a qualifying news organisation or publication that references you and your Twitter account.",
	"d5254e1c": "Provide a link that references your account as the official Twitter account for your organisation. The reference must come from the official website of a verified entity.",
	...
	"bd9d7f96": "The official website of a qualifying organisation that references you and your Twitter account.",
	...
	"c7f75eac": "An official website of a Verified organisation or publication that references your Twitter account.",
	...
	"h96ba9b6": "An official website of an advocacy organisation that references you and your Twitter account.",
	"e4610048": "Provide a link that references you in a leadership position for a Verified advocacy organisation and your Twitter account. The reference must come from the official site of a Verified organisation.",
	...
	"c78e091a": "An official website of a verified organisation that references you and your Twitter account.",
	"g5657ec4": "Provide a link that references you and your Twitter account. The reference must come from the official site of a Verified organisation.",
	...
	"d85ef4a8": "A reference to you and your Twitter account on the official website of a qualifying organisation.",
	...
	"a8d332f2": "Provide a link that references you as a senior leader at your organisation and your Twitter account. The reference must come from the official website of a verified entity.",
	...
	"e23b92c6": "An official website of a news organisation or publication that references your Twitter account.",
	...
	"eb89b0e0": "Help protect your account from unauthorised access by requiring a second authentication method in addition to your Twitter password. You can choose a text message, authentication app or security key.",
	...
	"bbe9579c": "You’re logged in to this Twitter account on this device and are currently using it.",
	...
	"a19f4b21": function(e){return"Logging out will end "+e.num+" of your other active Twitter sessions. It won’t affect your current active session."},
	...
	"acc60552": "Manage how Twitter uses your online activity outside of Twitter, such as the websites you visit, to personalise your experience.",
	"e9f48aee": "Allow Twitter to personalise your experience with your inferred activity, e.g. activity on devices you haven’t used to log in to Twitter.",
	"d7fcc4fa": "Allow sharing of additional information with Twitter’s business partners.",
	"a686c48a": "Manage the location information Twitter uses to personalise your experience.",
	...
	"c75c45d6": "Only allow messages from people that you follow",
	"c6f33c94": "You won’t receive any message requests",
	"gba4db78": "Only allow message requests from Verified users",
	"e3a8b282": "People that you follow will still be able to message you",
	"b4006390": "Allow message requests from everyone",
	"f7da127c": "Let people who you don’t follow send you message requests and add you to group conversations. To reply to their messages, you need to accept the requests.",
	...
	"b276596c": "This setting lets Twitter keep track of your visits to other websites that integrate Twitter content, such as embedded timelines. That information makes Twitter better for you, such as by personalising your experience. This web browsing history will never be stored with your name, email, or phone number.",
	...
	"f371a362": "Manage aspects of your Twitter experience such as limiting colour contrast and motion.",
	"a5ce82a4": "Manage your font size, colour and background. These settings affect all the Twitter accounts on this browser.",
	"f9c98140": "Manage which languages are used to personalise your Twitter experience.",
	...
	"fbc92b61": function(e){return"Twitter data ("+e.currentIndex+" of "+e.count+")"},
	...
	"h438b015": function(e){return"Tweet from "+e.fullName+" (@"+e.screenName+")"},
	"d91695cb": function(e){return e.fullName+" (@"+e.screenName+") Tweeted: "+e.tweet},
	...
	"j8eff20a": "Help keep Twitter a place for reliable information. Find out more before liking this Tweet.",
	"ce6df39e": "Help keep Twitter a place for reliable information. Find out more before sharing this Tweet.",
	...
	"j991cb30": "Never miss out on what’s happening by enabling Twitter notifications. Twitter will receive your device country and language to personalise your notifications.",
	...
	"e133be4e": "Unblock",
	"b3e6e1e7": function(e){return"Retweets from "+e.name+" will no longer appear in your timeline"},
	"e6b88abb": function(e){return"Retweets from "+e.name+" will appear in your timeline"},
	"c6ea308b": function(e){return e.fullName+" (@"+e.screenName+")"},
	"c1eb0fe5": function(e){return"Check out "+e.fullName+" on Twitter. "+e.bio},
	"c32a3d03": function(e){return"@"+e.screenName+" is no longer following you"},
	"badf3f35": function(e){return"You removed @"+e.screenName+" from flagged accounts"},
	...
	"a6450e84": "Block",
	"hb279a11": function(e){return"They will not be able to follow you or view your Tweets, and you will not see Tweets or notifications from @"+e.screenName+"."},
	...
	"ae3e9c81": function(e){return"Remove @"+e.screenName+" from Autoblocked accounts list?"},
	...
	"e1f2f8bd": function(e){return"Remove @"+e.screenName+" from Flagged accounts list?"},
	...
	"aa3ba124": "Even if you unfavourite this Topic, you may still see Tweets about it depending on which accounts you’re following.",
	"e0e730b0": "Interested",
	...
	"e554ba83": "Learn more",
	"b82a9ce8": "New Tweets are available. Push the period key to go to them.",
	...
	"e2d72d22": "Twitter Blue subscribers get early access to features such as Edit Tweet, which lets you update a Tweet up to 5 times within the first 1 hour after it’s published.",
	...
	"e2dd29b6": "Phone number or username",
	"jb4eb246": "Email address or username",
	"c150ba68": "Welcome!",
	...
	"ja03b44e": "Something went wrong. Try adding a Reaction to the Tweet again in a minute.",
	"da5c4380": "Can’t add Reactions to Tweets of protected users you aren’t following.",
	"f03dab2a": "You have been blocked from adding Reactions to this user’s Tweets at their request.",
	...
	"dd4a14a1": function(e){return"Your description"+n(e.numberOfImages," makes","s make")+" Twitter accessible to people with disabilities, and everyone who wants more context."},
	...
	"jc3c5f90": "Your Tweet has been sent. You have 1 hour to make any edits.",
	...
	"b551cd23": function(e){return"Your Tweet will be sent on "+e.scheduleDate+" at "+e.scheduleTime},
	...
	"ceec051c": "Twitter Circle lets you send Tweets to the people you choose only.",
	...
	"b64448c5": function(e){return e.userOneName+" "+e.userTwoName+" and "+n(e.othersCount,"One other",e.othersCount+" others")},
	"ged962b7": function(e){return e.trustedFriendsTweetOwner+"’s"},
	"e4625c2b": function(e){return e.userOneName+" "+e.userTwoName+" and "+n(e.othersCount,"One other",e.othersCount+" others")},
	...
	"d876b2bd": function(e){return"You can only attach up to "+e.count+" Tweets to this report."},
	...
	"cabba586": "Your blue tick will be hidden for a period of time after you edit your display name or profile photo until it is reviewed.",
	"je58d6aa": "Your profile is under review. After a short grace period, no new changes are allowed to your name and profile photo until the review has been completed.",
	...
	"f28690ae": "As a Blue subscriber, your blue tick will be hidden for a period of time after you edit your display name or profile photo until it is reviewed.",
	...
	"hc676c4b": function(e){return"You blocked @"+e.screenName},
	"ca95bd23": function(e){return"You removed @"+e.screenName+" from autoblocked accounts"},
	...
	"fdc10b7e": "Verified Organisations Subscriber",
	"cad64506": "You are receiving Twitter Blue because your organisation is a Verified Organisations subscriber. Contact your organisation for more details.",
	...
	"ea761738": "Share your favourite moments with 1080p (Full HD) video.",
	...
	"gaf181e0": "Organise your Bookmarks into folders and avoid endless scrolling.",
	...
	"iec0f526": "To get paid out for ads revenue sharing, make sure that you connect a Stripe account.",
	...
	"f1a160c6": "You can’t make changes to the price point you chose during set-up.",
	...
	"dc71aee8": "Support your favourite people on Twitter for bonus content and extra perks.",
	...
	"fdd95737": function(e){return e.minFollowersCount+" followers"},
	"b747ce3a": "Active in the past 30 days",
	"c27f57ac": "Be at least 18 years old",
	"gc13184a": "Subscribe to Twitter Blue or Verified Organisations",
	...
	"e92c089c": "Coins are virtual goods that can be received on eligible Tweets. As you receive Coins they accumulate into Diamonds, which can be cashed in.",
	...
	"i85091ac": "Blue looks good on you. Enjoy your verified account and blue tick once you’ve been approved.",
	...
	"ia0beb56": "Early access to selected new features",
	"af740df0": "Explore select new features.",
	"f5338950": "Extras",
	"i5cb232e": "Choose custom app icons and add quick access to your favourite destinations.",
	...
	"c6f58084": "Developers",
	"d83f18d2": "Directory",
	"a5208fae": "Manage aspects of your Twitter experience such as limiting colour contrast and motion. These settings affect all the Twitter accounts on this browser.",
	"d5b646be": "Vision",
	"jfe6a3a0": "Motion",
	"a6d5b010": "Timeline",
	...
	"e159eeee": "profile",
	"bad6cf6f": "your personalisation and data settings",
	...
	"d1a276bc": "These are the places Twitter uses to show you more relevant content. You won’t see places listed here if you turned off “Personalise based on places you’ve been”.",
	...
	"e97196fe": "Known for",
	"e652513e": "These are some of the interests matched to you based on your profile, activity and the Topics you follow. These are used to personalise your experience across Twitter, including the ads you see. You can adjust your interests if something doesn’t look right. Any changes you make may take a little while to go into effect.",
	...
	"d2b8e92b": function(e){return"If you have more than one Twitter account, you can add them and easily switch between. You can add up to "+e.maxAccounts+" accounts."},
	...
	"a6b9e23b": function(e){return"The email address is no longer associated with the Twitter account "+e.screenName+"."},
	...
	"g384dd98": "Tweet engagements divided by impressions.",
	...
	"j2d66822": "Given current evidence, I believe this Tweet is...",
	...
	"d6078a7e": "Community Notes depend on your ratings to keep quality high.",
	...
	"f84bcd3e": "By rating, you’re helping to ensure that notes shown on Tweets are helpful to people with varying points of view.",
	"f10aaf3c": "Note rating tips",
	"b87fa894": "We’re just starting to test Community Notes out",
	"c03d6a06": "Community Notes is a programme that lets people on Twitter collaboratively add context to Tweets to help keep people better informed. Notes can be rated by contributors and need to have the rating “currently rated helpful” in order to be public on Twitter.",
	"d1b02da2": "People have proposed Community Notes about this Tweet",
	"cc1f228e": "Community Notes is a programme where volunteer contributors add context (called “notes”) to Tweets they believe could be misleading. Notes below can be rated by contributors, and if they are currently rated helpful, they will be visible on Twitter. If a note is currently rated helpful, and you disagree, you can request additional review — meaning more contributors will review the note, and its rating could change. ",
	...
	"e804a3d8": "Looks like you’re not a part of the Community Notes pilot programme. Join now to help people stay better informed on Twitter.",
	...
	"ae5fa4b2": "As a Twitter Blue subscriber, you can customise your navigation in your mobile app’s Settings › Twitter Blue › Extras.",
	"d4945e44": "Community Notes is a programme that aims to create a better-informed world. It empowers people on Twitter to collaboratively add helpful notes to Tweets that might be misleading.",
	"jdb52860": "Contributors write and rate notes",
	"b468ea24": "Contributors are people on Twitter, just like you, who chose to enrol in the pilot to write and rate notes. The more people that participate, the better the programme becomes.",
	...
	"g98ea6c0": "Twitter doesn’t write, rate or moderate notes (unless they break the Twitter rules). We believe that giving people a voice to make these choices together is a fair and effective way to add information that helps people stay better informed.",
	...
	"hcf35d0d": function(e){return"Save theme as "+e.themeName},
	...
	"cceeaf2b": function(e){return"Unblock @"+e.screenName+"? They will be able to follow you and view your Tweets."},
	"j37c4674": "1 hour",
	...
	"a1bb552d": function(e){return"Tweet about "+e.hashtag},
	...
	"i8d6a27f": function(e){return e.title+" "+e.timelineHashtag+" by @"+e.author},
	...
	"caac124e": "There was unusual login activity on your account. To help keep your account safe, please enter your phone number or username to verify that it’s you.",
	"ab77e0b8": "There was unusual login activity on your account. To help keep your account safe, please enter your email address or username to verify that it’s you.",
	...
	"f9c558af": function(e){return"Want to login with your phone, @"+e.userScreenName+"?"},
	"haa104f0": "Send code",
	"h25bc384": "Use your password instead",
	"ecde12c1": function(e){return"You’ll get a code sent to "+e.phoneNumber+" to enter on the next screen."},
	...
	"bfaadb2d": function(e){return e.appName+" wants to access your Twitter account"},
	...
	"b0dbe914": "Use your phone number, email address or username",
	"ae03a21c": "See what’s happening",
	"j657d085": "Sign up",
	"fb9dd9b1": "Sign in",
	"d1cc8c06": "Limit unwelcome interactions",
	"c1da34c3": function(e){return"We flagged "+e.count+" potentially abusive or spammy account"+n(e.count,"","s")+"."},
	"j85176c1": function(e){return"We flagged more than "+e.count+" potentially abusive or spammy account"+n(e.count,"","s")+"."},
	...
	"cceeb26b": function(e){return e.query+" - Twitter Search"},
	"ac4fb0f4": "Photos",
	"bb967f9e": "Videos",
	"aea62568": "Search filters",
	"gfcfbf8c": "Your search was saved.",
	"a4645d92": "Your saved search was deleted.",
	"a8399d5b": function(e){return"See Tweets about "+e.query+" on Twitter. See what people are saying and join the conversation."},
	"ge893905": function(e){return"The latest Tweets on "+e.query+". Read what people are saying and join the conversation."},
	...
	"c5bb3cd2": "You’ll see Tweets about this in your Home timeline. This Topic will help personalise your experience across Twitter.",
	...
	"j70f0f35": function(e){return"Follow the "+e.topicName+" Topic on Twitter. You’ll see top Tweets from a number of accounts that are experts, fans or just tend to talk about "+e.topicName+" on Twitter."},
	...
	"f0c37ddb": function(e){return e.fullName+' on Twitter: "'+e.tweetText+'"'},
	...
	"ad666301": function(e){return e.fullName+" on Twitter"},
	...
	"b858a7cc": "This is a promoted Tweet. The number of times this Tweet has been seen is private.",
	...
	"fbdb85f5": function(e){return e.retweetCount+" Retweet"+n(e.retweetCount,"","s")},
	...
	"j401e4bd": function(e){return"This Tweet has earned "+e.impressions+" new impression"+n(e.impressions,"","s")+" and got "+e.engagements+" new engagement"+n(e.engagements,"","s")},
	"fbb5c37e": "Boost again",
	"c5c0b3bc": "Boost your Tweet",
	"g6bf2fdb": function(e){return"Your Tweet has earned "+e.impressions+" impression"+n(e.impressions,"","s")+" so far. Switch to a professional account to broaden your reach."},
	...
	"fc0d6d0d": "Twitter Voucher Terms",
	...
	"f22b6ad6": "You’re seeing top Tweets first. The latest Tweets will show up as they happen.",
	"g03a6be4": "See top Tweets",
	"gf89e0a2": "You’re seeing latest Tweets first. Top Tweets shows you the best Tweets.",
	...
	"fea74b67": function(e){return"@"+e.screenName+"’s Moments"},
	"ge3948d4": "Waiting for a Moment",
	"e2c8da06": "Moments are curated stories about what’s happening — powered by Tweets.",
	"df372b15": function(e){return"@"+e.screenName+"’s Moments will show up here."},
	"a357d876": "This account’s Moments are unavailable.",
	"d67658c1": function(e){return e.fullName+" (@"+e.screenName+") on Twitter"},
	"ccc9153f": function(e){return"Loading Tweets by @"+e.screenName},
	...
	"abb13fc9": function(e){return"About @"+e.screenName},
	"e9b67105": function(e){return"Loading @"+e.screenName+" about tab details"},
	...
	"dc1f8991": function(e){return"@"+e.screenName+" hasn’t Tweeted"},
	...
	"j0a37206": "Tweet now",
	"cc01c9b5": function(e){return e.fullName+"’s Tweets"},
	"c137eff1": function(e){return e.fullName+"’s Subscription Tweets"},
	"e8300dbb": function(e){return e.fullName+"’s Highlights"},
	"e021c003": function(e){return"Tweets with replies by "+e.fullName+" (@"+e.screenName+")"},
	...
	"d7c03c5d": function(e){return"Tweets liked by "+e.fullName+" (@"+e.screenName+")"},
	"a64da953": function(e){return"Loading Likes by @"+e.screenName},
	"a2f22d2d": function(e){return"@"+e.screenName+" hasn’t liked any Tweets"},
	...
	"f11f6625": function(e){return e.fullName+"’s liked Tweets"},
	"h10bba55": function(e){return"Media Tweets by "+e.fullName+" (@"+e.screenName+")"},
	"ia61ef0d": function(e){return"Loading Photos by @"+e.screenName},
	"d7b9138b": function(e){return"@"+e.screenName+" hasn’t Tweeted media"},
	...
	"d55be465": function(e){return e.fullName+"’s Photos"},
	...
	"ha62da97": function(e){return"@"+e.screenName+" is autoblocked"},
	...
	"ae71ff52": "You’re on the waiting list",
	...
	"b026896a": "Are you sure that you want to delete this job?",
	"dde8b306": "Deleting a job immediately removes it from your profile and jobs list.",
	"c131d364": "Start hiring on Twitter",
	"e3494c24": "Twitter Hiring is a free feature for Verified Organisations to post jobs, feature jobs on your company profile and attract top talent to your open positions.",
	"fc87bca6": "Join the waiting list",
	"a389380c": "By clicking \"Join the waiting list\" you consent to be contacted via email using the business email address associated with this account.",
	"c3f28126": "Reach a massive audience",
	"c1858dc4": "Twitter has over 528 million users. From software engineers to retail sales to forklift operators, your next hire is here.",
	...
	"b39996b8": "Cancelling Verified Organisations will result in your organisation immediately losing its gold tick.",
	"b0ae7088": "In addition, all affiliated accounts will be cancelled immediately and lose their gold or blue ticks and affiliate badges.",
	"dbf9667e": "I’m sure",
	...
	"eed17f3e": "Invite Twitter accounts to join your organisation. If they accept, they will get a tick, and your affiliation will be displayed on their profiles.",
	...
	"b2cee330": "Impersonation defence",
	...
	"h5e2fdd8": "Organisation Twitter handle",
	...
	"gf2d1998": "You will be able to leverage all the benefits of Twitter Blue, but your organisation will not receive a gold or grey tick and you will not be able to add affiliated accounts until your account is approved.",
	...
	"d3469342": "Organisations and affiliates",
	"gf77fdde": "Tax",
	...
	"jb4a1300": "Your selected scheduled Tweets have been deleted.",
	...
	"f7b714bc": "Customise your TweetDeck experience: choose the column width, colour, text and media size that is right for you.",
	...
	"b41ba996": "Following this Topic will help personalise your Home timeline and experience across Twitter",
	"h85446ce": "This browser is no longer supported.",
	"g9c2dec8": "Please switch to a supported browser to continue using twitter.com. You can see a list of supported browsers in our Help Centre.",
	"a138aeb2": "JavaScript is not available.",
	"ddf1d67c": "We’ve detected that JavaScript is disabled in this browser. Please enable JavaScript or switch to a supported browser to continue using twitter.com. You can see a list of supported browsers in our Help Centre.",
	...
	"h1888a33": function(e){return e.viewerCount+" viewer"+n(e.viewerCount,"","s")},
	...
	"dea63fc4": "When you Subscribe to your favourite Twitter creators, you get bonus content — and they earn a little money.",
	...
	"c41ea42e": "This Space was cancelled",
	"e03cff1d": function(e){return"Join a space "+e.title+" hosted by "+e.host+", with "+e.count+" others"},
	"b27cf499": function(e){return"Join a space hosted by "+e.host+", with "+e.count+" others"},
	"ace2ffe9": function(e){return"Join a space with "+e.count+" others"},
	...
	"gea7aa3c": "Next",
	"b6462b32": "Previous",
	"hdf426f5": function(e){return"Topic · "+e.description},
	"a3efd2c4": "Topic",
	...
	"e5e32275": function(e){return"Only people in @"+e.screenName+"’s Twitter Circle can see this Tweet"},
	...
	"hfc90ee9": function(e){return"Block @"+e.screenName},
	"e5630cdd": function(e){return"Block @"+e.screenName+"?"},
	"a9d050cc": "Block",
	"da82a3e7": function(e){return"They will not be able to follow you or view your Tweets, and you will not see Tweets or notifications from @"+e.screenName+"."},
	"a3d6d66f": function(e){return"Remove @"+e.screenName+" from Autoblocked accounts list?"},
	"h517e8d8": "Remove",
	...
	"hb7b0ceb": function(e){return e.retweetCount+" Retweet"+n(e.retweetCount,"","s")},
	...
	"i769b0ab": function(e){return e.count+" Retweet"+n(e.count,"","s")+". Retweet"},
	"ea9a1f0d": function(e){return e.count+" Retweet"+n(e.count,"","s")+". Retweeted"},
	...
	"gfaaead8": "Untitled",
	"cfd13f46": "Voice Dock",
	"aab35605": function(){return["Twitter always keeps a copy of a Space for review. ","."]},
	"fc9fe08f": function(){return["Spaces on web are listen-only. For the full experience, download the Twitter app for "," or ","."]},
	"a8170309": function(){return["Anyone can listen, including people not logged in to Twitter. "]},
	"ib602fd9": function(){return["You can control how your followers see the Spaces you’re listening to. "]},
	"i6164a47": function(){return["Twitter will keep a recording of Spaces for at least 30 days to review reports. "]},
	...
	"gee7fae9": function(){return["You’ll need to meet specific requirements depending on the type of Twitter account you have. "]},
	...
	"ec71430d": function(){return["Provide a link to your official campaign website referencing you as a candidate for government office at the local or national level and your Twitter account. "]},
	...
	"b8f15ec5": function(){return["Make sure your face and the text on your ID are clearly visible and legible. If not, you might have to resubmit. Twitter will not receive or store a copy of your ID. "]},
	...
	"jcd067dd": function(){return["Have fun and remember to follow the ","."]},
	...
	"f0e33253": function(){return["Depending on the setting that you select, different people can send you a direct message. "]},
	...
	"ib299459": function(){return["Once you’ve joined Twitter, you’ll be able to respond to ","’s Tweet."]},
	"ef1fd74f": function(){return["When you join Twitter, you can share ","’s Tweet with your followers."]},
	"ced7d5f7": function(){return["Join Twitter now to let "," know you like their Tweet."]},
	"b484f9b9": function(){return["Follow "," to see what they share on Twitter."]},
	"d1781a33": function(){return["Join Twitter now so you can share ","’s Tweet privately."]},
	"i55152d3": function(){return["Follow "," for curated Tweets"]},
	"i8773385": function(){return["Join Twitter now to see a stream of Tweets from people curated by ","."]},
	"c2de5d7b": function(){return["Join Twitter now to discover new and interesting conversations about the things that matter most to you, like ","."]},
	...
	"g8b28775": function(){return["Only @"+this.props.username+" and their Twitter Circle can see these Tweets."]},
	...
	"hc585ff1": function(){return["Changing your password will log you out of all your active Twitter sessions except the one you’re using at this time. The "," with access to your account won’t be affected. "]},
	"a4455c05": function(){return["Write it down, or take a screenshot, and keep it some place safe. This code can only be used once. "]},
	"e12a6841": function(){return["This is the primary country associated with your account. Your country helps us to customise your Twitter experience. "]},
	"ec152667": function(){return["These are the contacts that you have imported from your mobile devices. This information is used to personalise your experience on Twitter, such as suggesting accounts to follow. You can remove any contacts you’ve previously uploaded and turn off syncing with Twitter on all devices. Please be aware that this takes a little time. "]},
	"ia4557bf": function(){return["If enabled, you will be able to attach location information to your Tweets. "]},
	...
	"c97dfde5": function(){return["Want to edit your Twitter Circle? Go for it. People won`t be notified if you remove them. ","."]},
	...
	"b392dda9": function(){return["Replying to ",". "+this.props.trustedFriendsTweetOwner+"’s Twitter Circle will also be able to see your reply."]},
	"j316b6e3": function(){return["Replying to ",". "," Twitter Circle who follow you will also be able to see your reply."]},
	"c1378cbb": function(){return["Replying to ",". "," Twitter Circle will also be able to see your reply."]},
	...
	"g4dcd62b": function(){return["To use your current @username or email address with a different Twitter account, "," before you deactivate this account."]},
	"b44893f9": function(){return["If you want to download ",", you’ll need to complete both the request and download process before deactivating your account. Links to download your data cannot be sent to deactivated accounts."]},
	"e9dec56f": function(){return["You are confirming that ",", is accurate. If it’s not, your account may be affected."]},
	"d9ebec8d": function(){return["Twitter uses your age to customise your experience, including ads, as explained in our ","."]},
	"fad15501": function(){return["You can control who sees your birthday on Twitter. "]},
	...
	"a10d1459": function(){return["When you mute words, you won’t get any new notifications for Tweets that include them or see Tweets with those words in your Home timeline. "]},
	...
	"b8437d65": function(){return["Manage settings that help limit unwelcome interactions. "]},
	...
	"g313be81": function(){return["Double-check and confirm that your Subscription price is "+this.props.price+", "]},
	...
	"f2df3f23": function(){return["Control how Twitter customises your experience in "]},
	...
	"bf82b0a7": function(){return["If you haven’t provided a date of birth, we’ve provided an age range based on your Twitter profile and activity. Age information is used to personalise your experience. "]},
	...
	"e1d684b1": function(){return["To enable this, go to your "," settings and turn on “Personalise based on your inferred identity”."]},
	...
	"h7173353": function(){return["You can remove this information by disabling “Personalise based on your inferred identity” in your "," settings."]},
	"ad5f7017": function(){return["There are inferred hashes of email addresses that share common components with the email address you have provided to Twitter. You can remove this information by disabling “Personalise based on your inferred identity” in your "," settings."]},
	"f870a95b": function(){return["These are devices Twitter uses to improve and measure your experience on this browser. "]},
	"e21b623d": function(){return["These are browsers and devices associated with you. "]},
	"b6baf555": function(){return["These are browsers, devices, and information Twitter uses to personalise your experience. This includes devices and browsers you haven’t used to log in to Twitter, as well as email addresses and phone numbers like those linked to your Twitter account. "]},
	...
	"c2a54dcb": function(){return["Twitter’s partners build audiences around shopping decisions, lifestyle, and other online and offline behaviors. "]},
	"ba13ef23": function(){return["Something went wrong and your Twitter data couldn’t be sent. To request your data, please ","."]},
	...
	"j3c7dd33": function(){return["This Tweet might include sensitive content. "]},
	...
	"dfd2b3b9": function(){return[""," shared a Tweet"]},
	...
	"c4202785": function(){return["You added Reaction "," to @","’s Tweet"]},
	"b493a891": function(){return[""," added Reaction "," to @","’s Tweet"]},
	"ca684bf5": function(){return["You added Reaction "," to a Tweet"]},
	"h5797be5": function(){return["",' added Reaction "','" to a Tweet']},
	...
	"j1958651": function(){return["We need to know if the Twitter account "," is yours. If it isn’t, we’ll go ahead and remove "," from it."]},
	"c1567ae1": function(){return["If the Twitter account "," is yours, and you want to unsubscribe from future email notifications, go to "]},
	"hf714443": function(){return["We’ve removed your email address "," from the Twitter account ",". Now you won’t get Twitter notifications intended for that account."]},
	"a1c4702f": function(){return[""]},
	"g9aa2a63": function(){return["Someone might have inadvertently entered your email address when signing up for their Twitter account. Or, they might be using it to engage in abuse. You can report the account to help identify and remove spam from Twitter. "]},
	...
	"d9f77781": function(){return[this.props.impressions+"+ views"]},
	"c5c4d001": function(){return["As the Tweet author, you can "]},
	"if77e237": function(){return["You rated this note as ","."]},
	"c312ca7d": function(){return["You rated this note as ","."]},
	"j575fa79": function(){return["You "," with its conclusion."]},
	"h61f9ad3": function(){return["You "," with its conclusion."]},
	"d570f1d9": function(){return["You rated this note as "," and "," with its conclusion."]},
	"c6cb9513": function(){return["You rated this note as "," and "," with its conclusion."]},
	"fe957a43": function(){return["You rated this note as "," and "," with its conclusion."]},
	"gbfec7fd": function(){return["You rated this note as "," and "," with its conclusion."]},
	...
	"e80a0aff": function(){return["Context is written by people who use Twitter, and appears when rated as helpful by others. "]},
	"ec38eaf7": function(){return["Your use of the datasets is governed by the Twitter Developer Agreement and Policy. By clicking on the Download icon, you agree to the ","."]},
	"g19fcc5b": function(){return["File no. "+this.props.fileIndex+" of "+this.props.totalFiles]},
	"c43d1679": function(){return["See more at "]},
	...
	"h9fba3eb": function(){return["Notes aren’t available to read in your region yet. Follow "," for announcements and updates about Notes, or read more in our ","."]},
	...
	"ha49b9b7": function(){return["Viewing Tweets won’t unblock @"+this.props.screenName+". "]},
	...
	"i89d7b71": function(){return["Don’t have an account? "]},
	...
	"c5517273": function(){return["Times this Tweet has been seen. To learn more, visit the ","."]},
	"c770501b": function(){return["Times this Tweet has been seen. It can take a few minutes for the view count to appear. To learn more, visit the ","."]},
	"jaea7625": function(){return["View counts are not available for this Tweet. To learn more, visit the ","."]},
	"cace9785": function(){return["By clicking Create Promotion, you’re indicating that you have read and agree to the "," and ","."]},
	"c99d7101": function(){return["By clicking Create Promotion, you’re indicating that you have read and agree to the ","."]},
	"a063fb4b": function(){return["Some targeting options aren’t available for this ads account, in accordance with Twitter’s ","."]},
	"c9927419": function(){return["This Tweet doesn’t have any hidden replies, but Protected Tweets might be filtered out. "]},
	...
	"e645092b": function(){return["Are you sure you want to view these Tweets? Viewing Tweets won’t unblock @"+this.props.screenName+". "]},
	...
	"fdc023d7": function(){return[this.props.formattedCount+" Tweet"+n(this.props.count,"","s")]},
	...
	"ccade2e7": function(){return["You can’t follow or see @"+this.props.screenName+"’s Tweets. "]},
	...
	"c97724c3": function(){return["Only approved followers can see @"+this.props.screenName+"’s Tweets. To request access, click Follow. "]},
	"dd7d4939": function(){return["You turned on Safety Mode, so we autoblocked "," for a week. "+this.props.smartBlockEndTimeSentence]},
	"ef0a76ab": function(){return["You can view their profile to learn more about them, or go to their autoblocked Tweets to see why we autoblocked them. Neither one of these actions will remove the autoblock from ","."]},
	"f6fa2033": function(){return["Twitter suspends accounts which violate the "]},
	...
	"f06cbce7": function(){return["Manage your organisation on Twitter and unlock new features for businesses and government institutions. Learn more ","."]},
	"db0a35bd": function(){return["By clicking Apply now, you agree to our ",". Subscriptions auto-renew until cancelled, as described in the Terms. Accounts that sign up are reviewed for authenticity. If an account signs up and is not an organisation, you will be rejected and not refunded."]},
	...
	"babaae9b": function(){return[""," for help and how-to’s."]},
	...
	"h99e9c95": function(){return[""," Retweeted"]},
	"dd7a993b": function(){return["Only you and people in your Twitter Circle can see this Tweet. Retweeting, Quote Tweeting and sharing aren’t available. "]},
