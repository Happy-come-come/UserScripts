const text = {
	...
	"ga169e1b": function(e){return"Teachtaireachtaí Díreach "+e.count+" nach bhfuil léite "+i(e.count,e.count+" ch",e.count+" gc","1 ch",e.count+" ch",e.count+" ch")+"omhrá"},
	"i3ddb4fe": "SuperGrok",
	"d83682ec": "Home (New unread posts)",
	"e1249849": function(e){return"Fógraí ("+e.count+" nach bhfuil léite "+i(e.count,e.count+" fh",e.count+" bhf","1 fh",e.count+" f","2 fh")+"ógra)"},
	...
	"d4c52015": function(e){return e.count+" pending delegate account invitation"+o(e.count,"","s")},
	"b8e1d524": "Accounts",
	...
	"b93ba92d": function(e){return e.peopleCount+" "+i(e.peopleCount,"duine","daoine","duine","daoine","beirt")},
	...
	"aa037e65": function(e){return"View"+o(e.count,"","s")},
	...
	"f23d99b0": function(e){return"Bookmark"+o(e.count,"","s")},
	"e8866a55": function(e){return""+e.displayCount},
	"eb3abe45": function(e){return i(e.count,""+e.count,""+e.count,"1",""+e.count,""+e.count)+" Is maith liom"},
	"eff958fb": function(e){return""+e.displayCount},
	"i5a8c515": function(e){return"Quote"+o(e.count,"","s")},
	"dd77f9fb": function(e){return""+e.displayCount},
	"a755b81b": function(e){return"Repost"+o(e.count,"","s")},
	...
	"cface2d1": function(e){return"Member"+o(e.count,"","s")},
	...
	"h9f711f0": function(e){return i(e.count,""+e.count,""+e.count,"1",""+e.count,"2")+" Leantóir"},
	"jceadc3e": "Gan teideal",
	"a1d5303c": "Príobháideach",
	"cc8f8a80": "Díliostaithe",
	"c33a97d6": "Poiblí",
	"i73fff1b": function(e){return"Show "+e.count+" post"+o(e.count,"","s")},
	...
	"i57aeafb": function(e){return"For first "+o(e.duration,"month",e.duration+" months")+", then "+e.standardPrice+" billed monthly"},
	"ae3e3723": function(e){return"For first "+o(e.duration,"year",e.duration+" years")+", then "+e.standardPrice+" billed annually"},
	...
	"afdccedb": function(e){return"Show "+e.displayCount+" repl"+o(e.count,"y","ies")},
	...
	"ec2fc089": function(e){return"Your post"+o(e.numOfTweets," was","s were")+" sent to "+e.communityName},
	"c7152355": function(e){return"Ná déan dearmad do íomhá"+i(e.numberOfImages,"","nna","","","")+"ar fáil a dhéanamh"},
	...
	"a2d3facd": function(e){return"Your description"+o(e.numberOfImages," makes","s make")+" X accessible to people with disabilities, and everyone who wants more context."},
	"cc6d0a48": "You can turn off this reminder in Accessibility Settings.",
	"j499fbcb": function(e){return"Cuir "+i(e.numberOfImages,e.numberOfImages+" ch",e.numberOfImages+" gc","1 ch",e.numberOfImages+" c","2 ch")+"ur síos leis"},
	...
	"b7d8e3f1": function(e){return e.numberOfAltTextEntries+" íomhá "+i(e.numberOfAltTextEntries,"ch","gc","ch","c","ch")+"ur síos"},
	"d1175c78": "Clibeáil daoine",
	"b2943227": function(e){return"Upload caption file"+o(e.numberOfVideos,"","s")+" (.srt)"},
	"d0afbb37": function(e){return e.numberOfSubtitles+" caption file"+o(e.numberOfSubtitles,"","s")},
	...
	"a7daec1e": function(e){return"D"+i(e.count,"u","ao","u","ao","u")+"ine"},
	...
	"h758cd23": function(e){return e.userOneName+" "+e.userTwoName+" agus "+i(e.othersCount,e.othersCount+" ",e.othersCount+" n-","1 ",e.othersCount+" ",e.othersCount+" ")+"ainm úsáideora eile"},
	...
	"b8168f25": function(e){return e.userOneName+" "+e.userTwoName+" and "+o(e.othersCount,"1 other",e.othersCount+" others")},
	...
	"ba74e38b": function(e){return e.userOneName+" "+e.userTwoName+" and "+o(e.othersCount,"1 other",e.othersCount+" others")},
	...
	"a035ba65": function(e){return e.userOneName+" "+e.userTwoName+" and "+o(e.othersCount,"1 other",e.othersCount+" others")},
	"e4c52c45": function(e){return e.trustedFriendsTweetOwner+"’s"},
	"baf2c639": function(e){return e.userOneName+" "+e.userTwoName+" and "+o(e.othersCount,"1 other",e.othersCount+" others")},
	...
	"e6042757": function(e){return e.minutes+" minute"+o(e.minutes,"","s")+" and "+e.seconds+" second"+o(e.seconds,"","s")+" remaining to edit post"},
	"a4e39717": function(e){return e.minutes+" minute"+o(e.minutes,"","s")+" remaining to edit post"},
	...
	"ae0831ab": function(e){return"Ní féidir @"+e.screenName+" a chlibeáil i ngrianghraif"},
	...
	"c5ceafc8": "Replying",
	"f501ba43": function(e){return e.count+" more post"+o(e.count,"","s")},
	...
	"g62dcfbc": function(e){return"Coin"+o(e.count,"","s")},
	...
	"a03f5c73": function(e){return e.applicationCount+" "+i(e.applicationCount,"","n-","","","")+"aip"},
	"j25601d9": "Learn more",
	...
	"d04bb735": function(e){return e.formattedCount+" post"+o(e.count,"","s")},
	...
	"c2333081": function(e){return e.count+" character"+o(e.count,"","s")},
	"a2b8c54c": "Deleted",
	"a9cc8f96": "Max characters exceeded",
	"eb7710f1": function(e){return e.years+" yr"+o(e.years,"","s")},
	"bfc38bb5": function(e){return e.months+" mo"+o(e.months,"","s")},
	...
	"cd5c5e73": function(e){return"You may only have "+e.numDelegatesLabel+" delegat"+o(e.numDelegates,"e","ions")},
	...
	"fbb7764b": function(e){return e.count+" Coin"+o(e.count,"","s")},
	"e70a07b2": "Anonymous",
	...
	"ea522535": "Learn more",
	"hf5ca8f8": "profile",
	"d9cbe351": function(e){return e.count+" logáil isteach "+i(e.count,e.count+" ",e.count+" n-","1 ",e.count+" ",e.count+" ")+"ócáid"},
	"de90b04a": "Áiteanna a raibh tú",
	"cbd2ef59": function(e){return e.count+" "+i(e.count,e.count+" sh",e.count+" s","1 sh",e.count+" sh",e.count+" sh")+"uíomh"},
	"a4441bb8": "Interests from X",
	"e1c6b2d6": "Lucht spéise saincheaptha",
	"ed19d10d": function(e){return e.audienceCount+" "+i(e.audienceCount,""+e.audienceCount,""+e.audienceCount,"1",""+e.audienceCount,""+e.audienceCount)+" lucht suime ó "+e.advertiserCount+" "+i(e.advertiserCount,e.advertiserCount+" fh",e.advertiserCount+" bhf","1 fh",e.advertiserCount+" fh",e.advertiserCount+" fh")+"ógróir"},
	"f00d0d03": function(e){return e.count+" "+i(e.count,e.count+" sh",e.count+" s","1 sh",e.count+" sh",e.count+" sh")+"uim"},
	...
	"d750b93f": function(e){return e.count+" "+i(e.count,e.count+" bh",e.count+" mb","1 bh",e.count+" bh",e.count+" bh")+"rabhsálaí"},
	"a9783602": "Gléasanna Móibíleacha",
	"j043aa31": function(e){return e.count+" "+i(e.count,e.count+" ghléas mhóibíleacha",e.count+" ngléas mhóibíleacha","1 ghléas móibíleach",e.count+" ghléas mhóibíleacha",e.count+" ghléas mhóibíleacha")},
	...
	"f9b2d343": function(e){return e.count+" post"+o(e.count,"","s")},
	...
	"f5c7aaa7": function(e){return"host"+o(e.count,"","s")},
	"fc56c8b1": function(e){return"co-host"+o(e.count,"","s")},
	"iba0f45d": function(e){return"speaker"+o(e.count,"","s")},
	"dc066955": function(e){return"listener"+o(e.count,"","s")},
	"b53ed9ab": function(e){return e.participantCount+" "+e.title+" · "+e.remainingCapacityCount+" open spot"+o(e.remainingCapacityCount,"","s")},
	"c3b5b829": function(e){return e.count+" request"+o(e.count,"","s")},
	...
	"dd8272fd": function(e){return e.count+" new message"+o(e.count,"","s")},
	...
	"i8d5e62b": function(e){return e.count+" duine eile"},
	...
	"ca7a2215": function(e){return"Do fhreagra reatha: "+e.emoji},
	...
	"bbe74f3f": function(e){return"Inné, "+e.time},
	"h95f9e77": function(e){return e.reactionCount+" reaction"+o(e.reactionCount,"","s")},
	"c0098d4a": "Freagraí",
	"j85999ec": "Liosta Freagraí Úsáideora",
	"a2d48779": function(e){return"Bain do fhreagra reatha: "+e.emoji},
	"icd0bf34": "Feicthe",
	"e8bd8fec": "Seolta",
	"b2d32fae": "Feicthe ag cách",
	"a763d33f": function(e){return"Feicthe ag "+e.count+" "+i(e.count,e.count+" dh",e.count+" nd","1 d",e.count+" d",e.count+" dh")+"uine"},
	"d84b485e": "Lean tú an cuntas seo",
	"be0c83d8": "Ghlac tú leis an iarratas",
	"e535cae9": function(e){return e.count+" Leantóir"+i(e.count,"í","í","","í","í")},
	...
	"f7e1ad65": function(e){return"An bhfuil tú ag iarraidh ligean do "+e.senderName+" teachtaireachtaí a sheoladh chugat? Ní bheidh a fhios ag an duine sin go bhfaca tú an teachtaireacht go dtí go nglacfaidh tú léi."},
	...
	"d571e4f9": function(e){return"Ní féidir leat ach  "+e.count+" c"+i(e.count,"","","h","","h")+"omhráa ghreamú"},
	...
	"f041be05": function(e){return e.stringCount+" iarrta"+i(e.count,"","","","i","")+"s ar feitheamh"},
	"a2fad0f3": function(e){return e.stringCount+" d"+i(e.count,"u","ao","u","ao","u")+"ine nua go bhfuil aithne agat air seans"},
	"cbddf365": function(e){return e.stringCount+" duine go bhfuil a"+i(e.count,"","ithne a","ithne a","ithne a","ithne a")+"gat air seans"},
	"fac945ad": function(e){return e.stringCount+" iarrta"+i(e.count,"i","","","","")+"s nua"},
	...
	"a3186bff": function(e){return e.count+" web page"+o(e.count,"","s")},
	"b52484b6": "Searching...",
	...
	"e15e5637": function(e){return i(e.count,e.count+"u",e.count+"u","U",e.count+"u",e.count+"u")+"air dheiridh"},
	...
	"ce447fcb": function(e){return e.count+" Éisteoir"+i(e.count,"í","í","","í","í")},
	...
	"e4e811fc": "Ag ceangal ....",
	"aadbc747": function(e){return"Co-host"+o(e.hostCount,"","s")},
	"hbd6035f": function(e){return"Speaker"+o(e.speakerCount,"","s")},
	...
	"a4d4bcb9": function(e){return"If you want to rejoin, you will be able to do so here in "+e.numDaysToRejoin+" day"+o(e.numDaysToRejoin,"","s")+"."},
	"a490bc51": "Learn more",
	...
	"dfd5031f": function(e){return e.newTweets+" new post"+o(e.newTweets,"","s")},
	"ha4bb8a9": function(e){return e.reportedTweets+" report"+o(e.reportedTweets,"","s")},
	"caf003b3": function(e){return e.memberRequests+" request"+o(e.memberRequests,"","s")},
	"a2118086": "Sort posts",
	...
	"d755f47d": function(e){return e.count+" new post"+o(e.count,"","s")+" to review"},
	"efc26607": function(e){return e.memberCount+" "+i(e.memberCount,e.memberCount+" bh",e.memberCount+" mb","1 bh",e.memberCount+" b","2 bh")+"all"},
	...
	"dde5f323": function(e){return e.count+" Iarrata"+i(e.count,"","","i","","")+"s ó bhaill nua atá le hathbhreithniú"},
	...
	"i6568549": function(e){return"You have "+e.remaining_invite_count+" invite"+o(e.remaining_invite_count,"","s")+" left"},
	...
	"e2bc5db0": "@X",
	"d0a1b248": function(e){return e.formattedCount+" member"+o(e.count,"","s")},
	"cd4d48d2": "@X",
	"ff0f742a": function(e){return e.formattedCount+" member"+o(e.count,"","s")},
	...
	"e1bde73f": function(e){return"Ní féidir teachtaireacht a sheoladh chuig @"+e.screenName},
	...
	"a7f20223": function(e){return"Fógraí suain ó "+e.name},
	"g2f04a6b": function(e){return"Níl "+e.name+" ar suan"},
	"i453fedf": function(e){return"Ar suan go dtí "+e.expiration},
	...
	"f24af200": "Block DMs",
	"a30e1677": function(e){return"Cuir cosc ar @"+e.screenName+", ní bheidh @"+e.screenName+" ábalta thú a leanúint níos mó ná teachtaireacht a sheoladh chugat, agus ní fheicfidh tú aon fhógra ó @"+e.screenName+"."},
	...
	"je7e1fed": function(e){return"Tá "+e.name+" curtha ar suan agat le haghaidh 1 uair an chloig"},
	"hf94a2d6": "Balbhaithe ar feadh 1 uair an chloig",
	"fb7a43c6": "8 n-uair an chloig",
	"e95c8f8b": function(e){return"Tá "+e.name+" curtha ar suan agat le haghaidh 8 n-uair an chloig"},
	"bd54fad2": "Balbhaithe ar feadh 8 n-uair an chloig",
	"cb5bf56e": "1 seachtain",
	"gb7a130b": function(e){return"Tá "+e.name+" curtha ar suan agat le haghaidh 1 seachtain"},
	"f6fce0fe": "Balbhaithe ar feadh 1 seachtain",
	"i78153dd": function(e){return"Tá "+e.name+" curtha ar suan agat go deo"},
	...
	"g055a9ce": "Open 𝕏 App",
	"g931a6e5": function(e){return"Tá tú ag leanúint "+e.topic},
	...
	"da68fff1": function(e){return e.count+" Coin"+o(e.count,"","s")+" (only visible to you)"},
	...
	"ib1f8491": function(e){return e.likeCount+" "+i(e.likeCount,""+e.likeCount,""+e.likeCount,"1",""+e.likeCount,"2")+" Is maith liom"},
	"dc0e7f37": function(e){return e.retweetCount+" repost"+o(e.retweetCount,"","s")},
	"d0eeb127": function(e){return e.replyCount+" "+i(e.replyCount,e.replyCount+" fh",e.replyCount+" bhf","1 fh",e.replyCount+" f","2 fh")+"reagra"},
	...
	"ccffb487": function(e){return"Your post has earned "+e.impressions+" impression"+o(e.impressions,"","s")+" so far. Switch to a professional account to broaden your reach."},
	"ha13fd94": "Boost post",
	...
	"bad70c09": function(e){return"Location"+o(e.numLocations,"","s")},
	"c133a39b": function(e){return e.minAge+"-"+e.maxAge},
	"ee5da8f5": function(e){return e.minAge+"+"},
	"g4bf9cb7": function(e){return e.durationDays+" day"+o(e.durationDays,"","s")},
	...
	"ea7ce65f": function(e){return e.count+" bonus Coin"+o(e.count,"","s")+" included."},
	...
	"j8318d57": function(e){return e.number+" affiliate"+o(e.number,"","s")},
	...
	"b651c7d7": function(e){return"Affiliate"+o(e.count,"","s")+" x "+e.count},
	...
	"daa73df1": function(e){return e.viewerCount+" view"+o(e.viewerCount,"","s")},
	...
	"dbeae6cf": function(e){return e.count+" other listener"+o(e.count,"","s")},
	...
	"d925a4f9": function(e){return e.formattedCount+" minute"+o(e.count,"","s")+" left"},
	"ib15cddb": function(e){return e.formattedCount+" hour"+o(e.count,"","s")+" left"},
	"db9ed19f": function(e){return e.formattedCount+" day"+o(e.count,"","s")+" left"},
	"e1ebcecb": function(e){return e.formattedDays+" lá "+e.formattedHours+"uair fágtha"},
	"cc1da1fd": function(e){return e.formattedHours+" "+i(e.hours,"n-","n-","","","")+"uair an chloig "+e.formattedMins+" nóiméad fágtha"},
	"f89a5d60": "Óstach",
	...
	"f8e8e32e": "Tusa",
	"df6703d3": "Tusa",
	"c20f7e9f": function(e){return i(e.otherUsersCount,d.createElement(d.Fragment,null,"",e.otherUsersCount," ",e.secondName),d.createElement(d.Fragment,null,"",e.otherUsersCount," ",e.secondName),d.createElement(d.Fragment,null,"","","1 ",e.secondName),d.createElement(d.Fragment,null,"",e.otherUsersCount,e.secondName),d.createElement(d.Fragment,null,"",e.otherUsersCount," ",e.secondName))},
	"he26f627": function(e){return i(e.otherUsersCount,d.createElement(d.Fragment,null,"",e.otherUsersCount," ",e.secondName),d.createElement(d.Fragment,null,"",e.otherUsersCount," ",e.secondName),d.createElement(d.Fragment,null,"",e.secondName),d.createElement(d.Fragment,null,"",e.otherUsersCount," ",e.secondName),d.createElement(d.Fragment,null,"",e.otherUsersCount," ",e.secondName))},
	"gea7aa3c": "Ar aghaidh",
	"b6462b32": "Roimhe seo",
	"caddb529": "and",
	"ff31714c": function(e){return"agus "+i(e.othersCount,""+e.othersCount,""+e.othersCount,"1",""+e.othersCount,"2")+" eile"},
	"e06c99b7": "agus",
	"i4e2f96c": function(e){return"agus "+i(e.othersCount,""+e.othersCount,""+e.othersCount,"1",""+e.othersCount,"2")+" eile"},
	...
	"e82adfeb": function(e){return e.count+" web page"+o(e.count,"","s")},
	"cfb8c1f7": function(e){return e.count+" post"+o(e.count,"","s")},
	...
	"c2b81e9d": function(e){return i(e.count,""+e.count,""+e.count,"1",""+e.count,""+e.count)+" vóta "+e.formattedCount},
	"e86732e4": "Roghnaithe",
	...
	"db11b27f": function(e){return e.count+" character"+o(e.count,"","s")+" remaining"},
	...
	"e3098e07": function(e){return e.minutes+" minute"+o(e.minutes,"","s")+" ago"},
	"fea16a51": function(e){return e.hours+" hour"+o(e.hours,"","s")+" ago"},
	"a4f2d94d": function(e){return e.days+" day"+o(e.days,"","s")+" ago"},
	"hf9bc787": function(e){return e.weeks+" week"+o(e.weeks,"","s")+" ago"},
	"efcd5885": function(e){return e.months+" month"+o(e.months,"","s")+" ago"},
	"c37228b5": function(e){return e.years+" year"+o(e.years,"","s")+" ago"},
	"jf83d092": "Lá",
	"af4abf20": "Mí",
	"b871f280": "Bliain",
	"hac89ab0": "Eanáir",
	...
	"f06ae5d3": function(e){return e.standardTweetCount+" character"+o(e.standardTweetCount,"","s")+" remaining for a standard post, "+e.totalCount+" character"+o(e.totalCount,"","s")+" remaining total"},
	"fee0a8bc": "Sábháil",
	"ae7f7656": "Glan",
	...
	"b8c465e2": "Reposted",
	"c7a989ce": "Bookmarked",
	"b03835c7": function(e){return e.replyCount+" "+i(e.replyCount,e.replyCount+" fh",e.replyCount+" bhf","1 fh",e.replyCount+" f","2 fh")+"reagra"},
	"g4a195e7": function(e){return e.retweetCount+" repost"+o(e.retweetCount,"","s")},
	"e089b42d": function(e){return e.likeCount+" "+i(e.likeCount,""+e.likeCount,""+e.likeCount,"1",""+e.likeCount,"2")+" Is maith liom"},
	"e0a8fe39": function(e){return e.bookmarkCount+" bookmark"+o(e.bookmarkCount,"","s")},
	"c58b2ab7": function(e){return e.viewCount+" "+i(e.viewCount,e.viewCount+" amharc",e.viewCount+" n-amharc","amharc amháin",e.viewCount+" amharc","2 amharc")},
	"f2849136": "Anailísíocht",
	"f206e970": "View post analytics",
	"c7073f5b": function(e){return e.count+" view"+o(e.count,"","s")+". View post analytics"},
	"hf417cf0": "Remove from Bookmarks",
	"febd30ed": function(e){return e.count+" Bookmark"+o(e.count,"","s")+". Bookmark"},
	"a8dc9587": function(e){return e.count+" Bookmark"+o(e.count,"","s")+". Bookmarked"},
	"d636ebc6": "Thaitin seo le",
	"eb3a8b0c": "Bain Is maith liom",
	"j472ecfc": "Like this post",
	"dac92b0d": function(e){return e.count+" "+i(e.count,""+e.count,""+e.count,"1",""+e.count,""+e.count)+" Is maith liom. Tabhair is maith liom"},
	"aa650427": function(e){return e.count+" "+i(e.count,""+e.count,""+e.count,"1",""+e.count,""+e.count)+" Is maith liom. Is maith liom faighte"},
	"hdf7226a": "Freagair",
	"c9940955": function(e){return e.count+" "+i(e.count,e.count+" Fh",e.count+" bhF","1 F",e.count+" Fh",e.count+" Fh")+"reagra. Freagra"},
	"f2919fb8": "Repost",
	"fd1e5446": "Undo repost",
	"dfad425d": function(e){return e.count+" repost"+o(e.count,"","s")+". Repost"},
	"a386dc55": function(e){return e.count+" repost"+o(e.count,"","s")+". Reposted"},
	...
	"daf8a75f": function(e){return i(e.count,""+e.count,""+e.count,"1",""+e.count,"2")+" Á leanúint"},
	"ef1f4fc6": function(e){return""+e.formattedCount},
	"ad9b5988": function(e){return i(e.count,""+e.count,""+e.count,"1",""+e.count,"2")+" Leantóir"},
	"a9980948": function(e){return""+e.formattedCount},
	"ce44a35c": function(e){return"Subscriber"+o(e.count,"","s")},
	"id949f68": function(e){return""+e.formattedCount},
	"hb608cfc": function(e){return"Subscription"+o(e.count,"","s")},
	...
	"b6656851": function(){return["Tá "+this.props.count+" "+i(this.props.count,"dh","nd","d","d","dh")+"uine eile sa ghrúpa seo"]},
	...
	"eea0a14f": function(){return[this.props.formattedCount+" "+i(this.props.count,""+this.props.count,""+this.props.count,"1",""+this.props.count,"2")+" Is maith liom"]},
